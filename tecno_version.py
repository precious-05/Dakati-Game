...
class PrinciplesScreen(ModalView):
    def _init_(self, on_dismiss_callback=None, **kwargs):
        super()._init_(**kwargs)
        self.size_hint = (1, 1)
    ...
    def build_ui(self):
        ...
        btn_layout = BoxLayout(size_hint_x=0.6,size_hint_y=None, height=dp(50), spacing=dp(10)   ,pos_hint={'center_x': 0.5, 'center_y': 0.5}  )
        back_btn = Button(
            text="Back",
          #  size_hint=(0.5, 0.99),
