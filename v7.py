...
<RoleRevealScreen>:
    ...
    BoxLayout:
        ...
        # Player Name (biggest and boldest)
        Label:
        ...
        Label:
            ...
            font_size: '36sp'
            bold: True
            color: (0.9, 0.9, 0.1, 1)  # Yellow for visibility
            outline_width: 2
            outline_color: (0, 0, 0, 1)
            size_hint_y: None
        ...
        Label:
            ...
            font_size: '42sp'
            bold: True
            color: (0.8, 0.5, 0.9, 1)  # Purple for visibility
            outline_width: 2
            outline_color: (0, 0, 0, 1)
            size_hint_y: None
            height: self.texture_size[1] + dp(20)
...
class DakatiGame(BoxLayout):
    ...
    def update_role_reveal(self):
        ...
        role_descriptions = {
            'Thief': 'Work with your partner to eliminate citizens',
